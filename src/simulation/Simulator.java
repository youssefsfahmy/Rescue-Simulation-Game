	...
	private void loadUnits(String path) throws Exception {
		...
		while (line != null) {
			...
			case "AMB": {
				...
				break;
			case "DCU": {
				DiseaseControlUnit d = new DiseaseControlUnit(id, world[0][0], steps, this);
				emergencyUnits.add(d);
			}
				break;
			case "EVC": {
				Evacuator e = new Evacuator(id, world[0][0], steps, this, Integer.parseInt(info[3]));
			...
			case "FTK": {
				...
				break;
			case "GCU": {
				GasControlUnit g = new GasControlUnit(id, world[0][0], steps, this);
