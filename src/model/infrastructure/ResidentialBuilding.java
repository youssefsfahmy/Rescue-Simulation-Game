...
public class ResidentialBuilding implements Rescuable, Simulatable 
{
	...
	public String tohtmlString(){
		String x = "No Disaster";
		if(getDisaster()!=null){
			x = getDisaster().getDisasterName();
		}
		return "<html> Building info <BR>"
				+ "Location: " + getLocation().getX() + " , "
				+ getLocation().getY() + "<BR>" 
				+ "Structural Integrity: "+ getStructuralIntegrity() + "<BR>" 
				+ "Fire Damage "+ getFireDamage() + "<BR>" 
				+ "Gas Level: "	+ getGasLevel() + "<BR>" 
				+ "Foundation Level: "+ getFoundationDamage() + "<BR>"
				+ "Number of citizens:  "+ getOccupants().size() +"<BR>"
				+ "Disaster:  "+ x 
				+ "</html>";
	}
	@Override
	public String getTargetName() {
		return "Building's Location: " + getLocation().getX() + " , " + getLocation().getY() ; 
	}
	public String toLabelString() {
		return "**The Building at"+" ( "+ this.getLocation().getX() + 
				","+ this.getLocation().getY()+ " ) "  + " is destroyed";
	}
}
