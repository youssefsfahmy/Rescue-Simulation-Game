...
public class Citizen implements Rescuable,Simulatable{
	...
	public String tohtmlString(){
		...
		return "<html> Citizen's Info <BR>"
				+ "Location: " + getLocation().getX() + " , " + getLocation().getY() + "<BR>" 
				+ "Name "+ getName() + "<BR>" 
				+ "Age: "+ getAge() + "<BR>" 
				+ "National ID: " + getNationalID() + "<BR>"
				+ "HP:  " + getHp() + "<BR>"
				+ "Blood Loss:  " + getBloodLoss() + "<BR>"
				+ "Toxicity:  " + getToxicity()+ "<BR>"
				+ "State:  " + getState() + "<BR>" 
				+ "Disaster:  " + x + "</html>";
	}
	public String toLabelString() {
		return "**The Citizen " + this.getName() + "at the location " +" ( "+ this.getLocation().getX() + 
				","+ this.getLocation().getY()+ " )"  + "has died.";
